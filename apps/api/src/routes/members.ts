...
import { auditLogs, notes, users, workspaceInvites, workspaceMembers, workspaces } from "../db/schema.ts";
...
memberRoutes.post("/workspaces/:id/leave", async c => {
  ...
  await db.transaction(async tx => {
    ...
    await dropWorkspaceFromMcpTokens(tx, { workspaceId: wsId, userId: u.id, empty: "revoke" });
