...
import { adminAiIndexRoutes } from "./routes/admin-ai-index.ts";
import { adminPlatformAiRoutes } from "./routes/admin-platform-ai.ts";
import { serviceRoutes } from "./routes/services.ts";
import { agentRoutes } from "./routes/agents.ts";
import { memberRoutes } from "./routes/members.ts";
import { interactionRoutes } from "./routes/interactions.ts";
import { noteCommentRoutes } from "./routes/note-comments.ts";
...
app.route("/api/v1", adminAiIndexRoutes);
app.route("/api/v1", adminPlatformAiRoutes);
...
app.route("/api/v1", noteCommentRoutes);
